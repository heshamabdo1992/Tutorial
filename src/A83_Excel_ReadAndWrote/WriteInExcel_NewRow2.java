...
public class WriteInExcel_NewRow2 {
...
//			cell.setAsActiveCell();
			...
			cell.setCellValue(dataToWrite[j][0]);
	...
	public static void main(String... strings) throws IOException {
		...
		String[][] valueToWrite = {{ "Mr. E", "Noida" },{ "Mr. E2222", "Noida2222" } };

	
		// Create an object of current class
		WriteInExcel_NewRow2 objExcelFile = new WriteInExcel_NewRow2();

		// Write the file using file name, sheet name and the data to be filled
		objExcelFile.writeExcel("D:\\eclips\\Work_Space\\Tutorial\\ReadFrom", "Test_Data_sheet.xlsx",
				"Sheet1", valueToWrite);
