...
public class ExcelWrite_in_specificCell{
    ...
    public  ExcelWrite_in_specificCell(String xlFilePath) throws Exception
    {
    ...
    public static void main (String []arg) throws Exception{
    	 ...
    	 String filepath = ".\\OutputTo\\test.xlsx";
    	    ...
    	    ExcelWrite_in_specificCell objExcelFile = new ExcelWrite_in_specificCell(filepath);	
